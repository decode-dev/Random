<%@ Page Language="C#" AutoEventWireup="true" CodeFile="AdminOwners.aspx.cs" Inherits="AdminOwners" %>
                    ...
                    <td class="style7">
                        <asp:Panel ID="Panel1" runat="server" BackColor="#FFCC99" BorderColor="#FF6600" 
                            ...
                            <asp:SqlDataSource ID="SqlDataSource1" runat="server" 
                                ...
                                SelectCommand="SELECT [Username], [Age], [Email], [Mobile], [Address] FROM [OwnerReg]">
                            </asp:SqlDataSource>
                        </asp:Panel>
                    </td>
                    <td>
