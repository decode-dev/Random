<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Userfiledetails.aspx.cs" Inherits="Userfiledetails" %>
...
<div id="wrapper">
    ...
    SelectCommand="SELECT [Fid], [oname], [filename], [status], [date] FROM [ofileup]"></asp:SqlDataSource>
                        </asp:Panel>
                    </td>
                    <td>
                        &nbsp;</td>
