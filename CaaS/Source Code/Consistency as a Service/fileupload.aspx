                    ...
                    <td class="style7">
                        <asp:Panel ID="Panel1" runat="server" BackColor="#FFCC99" BorderColor="#FF6600" 
                            ...
                            <table class="style8">
                                ...
                                <tr>
                                    <td class="style9">
                                        <asp:Label ID="Label1" runat="server" Font-Bold="True" Text="File ID"></asp:Label>
                                    </td>
                                    <td class="style10">
                                ...
                                <tr>
                                    <td class="style9">
                                        <asp:Label ID="Label2" runat="server" Font-Bold="True" Text="Choose the File"></asp:Label>
                                    </td>
                                    <td class="style10">
                                ...
                                <tr>
                                    ...
                                    <td class="style11">
                                        <asp:Button ID="Button1" runat="server" BackColor="#CC9900" Font-Bold="True" 
                                            Text="Upload" onclick="Button1_Click" Width="92px" style="height: 26px" />
                                        &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                                    </td>
                                    <td>
                                        &nbsp;</td>
