<%@ Page Language="C#" AutoEventWireup="true" CodeFile="TPAHome.aspx.cs" Inherits="TPAHome" %>
			...
			&nbsp;<table class="style1">
                ...
                <tr>
                    <td class="style5">
                        &nbsp;</td>
                    <td class="style7">
                        <asp:Image ID="Image1" runat="server" Height="343px" 
                            ImageUrl="~/images/Arch.JPG" Width="502px" />
                    </td>
                    <td>
                        &nbsp;</td>
                </tr>
