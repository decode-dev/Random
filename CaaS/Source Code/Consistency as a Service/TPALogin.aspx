<%@ Page Language="C#" AutoEventWireup="true" CodeFile="TPALogin.aspx.cs" Inherits="TPALogin" %>
                                ...
                                <tr>
                                    ...
                                    <td class="style11">
                                        <asp:Button ID="Button1" runat="server" BackColor="#CC9900" Font-Bold="True" 
                                            Text="Login" onclick="Button1_Click" style="height: 26px" />
                                        &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; &nbsp;&nbsp;
                    ...
                    <tr>
                        ...
                        <td class="style17">
                            <asp:Button ID="Button7" runat="server" BackColor="#660066" 
                                BorderColor="#66FFFF" BorderStyle="Double" Font-Bold="True" Font-Size="Medium" 
                                ForeColor="#66FFFF" onclick="Button7_Click" Text="Data Owner" Width="147px" 
                                CausesValidation="False" />
                        </td>
                        <td>
                            &nbsp;</td>
