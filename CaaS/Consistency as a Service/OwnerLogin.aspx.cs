...
public partial class OwnerLogin : System.Web.UI.Page
{
    ...
    {
        con.Open();
        SqlCommand cmd = new SqlCommand("select Username from OwnerReg where Username = '"+TextBox1.Text+"'",con);
        SqlCommand cmd1 = new SqlCommand("select Password from OwnerReg where Username = '"+TextBox1.Text+"'",con);
    ...
    {
        Response.Redirect("OwnerRegister.aspx");
    }    
}
